...
export type RigErrorInput = Enum<{ BadAsset: [], BadMigration: undefined, AlreadyInitialized: undefined, NotInitialized: undefined, Overflow: undefined, NoStakingDeposits: undefined, NotOperator: undefined, RigIsPaused: undefined, RigIsNotPaused: undefined, InvalidPauser: undefined, PriceIsStale: undefined, InsufficientAmountOut: undefined }>;
export type RigErrorOutput = Enum<{ BadAsset: [], BadMigration: void, AlreadyInitialized: void, NotInitialized: void, Overflow: void, NoStakingDeposits: void, NotOperator: void, RigIsPaused: void, RigIsNotPaused: void, InvalidPauser: void, PriceIsStale: void, InsufficientAmountOut: void }>;
...
export type DepositEventInput = { sender: IdentityInput, referral: Option<IdentityInput>, amount_deposited: BigNumberish, amount_minted: BigNumberish };
export type DepositEventOutput = { sender: IdentityOutput, referral: Option<IdentityOutput>, amount_deposited: BN, amount_minted: BN };
export type InitialSetupEventInput = { l1_rig_address: string, initial_owner: IdentityInput, pauser: IdentityInput, max_stale_time: BigNumberish };
export type InitialSetupEventOutput = { l1_rig_address: string, initial_owner: IdentityOutput, pauser: IdentityOutput, max_stale_time: BN };
export type OperatorAddressUpdatedEventInput = { operator_address: IdentityInput, is_operator: boolean };
export type OperatorAddressUpdatedEventOutput = { operator_address: IdentityOutput, is_operator: boolean };
...
export type SetPriceFeedContractEventInput = { price_feed_contract: ContractIdInput };
export type SetPriceFeedContractEventOutput = { price_feed_contract: ContractIdOutput };
...
export class Rig extends Contract {
  ...
  declare functions: {
    deposit: InvokeFunction<[referral: Option<IdentityInput>, min_amount_out: BigNumberish], void>;
    ...
    initialize: InvokeFunction<[l1_rig_address: string, pauser: IdentityInput, max_stale_time: BigNumberish], void>;
    ...
    set_price_feed_contract: InvokeFunction<[price_feed_contract: ContractIdInput], void>;
    transfer_ownership: InvokeFunction<[new_owner: IdentityInput], void>;
    unpause: InvokeFunction<[], void>;
    update_operator_address: InvokeFunction<[operator_address: IdentityInput, is_operator: boolean], void>;
