...
export type Src14Configurables = Partial<{
...
export class Src14Interface extends Interface {
  constructor() {
    super(abi);
  }
...
export class Src14 extends Contract {
  static readonly abi = abi;
  static readonly storageSlots = storageSlots;

  declare interface: Src14Interface;
  declare functions: {
